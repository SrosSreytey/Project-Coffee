...
if (loginForm) {
    loginForm.addEventListener(
        ...
        function (event) {
            ...
            // Get registered user
            const registeredUser =JSON.parse( localStorage.getItem("brewHavenUser" ));
            // Check account
            if (!registeredUser) {
...
if (registerForm) {
    registerForm.addEventListener(
        ...
        function (event) {
            ...
            // ================= CHECK EXISTING USER =================
            const existingUser =JSON.parse( localStorage.getItem( "brewHavenUser"
                    )
                );
            if (
                existingUser &&
...
document.addEventListener( "DOMContentLoaded", function () {
        ...
        const payment =document.querySelector( 'input[name="payment"]:checked').value;
                ...
                // Get old orders
                const orders = JSON.parse(localStorage.getItem( "brewHavenOrders" )  ) || [];
                // Add new order
                orders.push(order);
                // Save orders
